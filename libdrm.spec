...
Conflicts: xorg-x11-drv-nouveau < 1:0.0.16-9
...
%{_includedir}/nouveau/nv04_pushbuf.h
...
%changelog
* Fri Oct 21 2011 Dave Airlie <airlied@redhat.com> 2.4.25-2
- fix udev permission problem (#747965)

* Tue Jun 28 2011 Adam Jackson <ajax@redhat.com> 2.4.25-1
- libdrm 2.4.25 (#713770)

* Thu Jan 13 2011 Adam Jackson <ajax@redhat.com> 2.4.23-1
- libdrm 2.4.23 (#633226)
- Update nouveau conflicts for new ABI
